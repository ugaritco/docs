...
Ugarit includes a variety of functions for manipulating string values. Many of these functions are used by the framework itself; however, you are free to use them in your own applications if you find them convenient.
...
$url = Str::chopStart('https://ugarit.com', 'https://');
...
$url = Str::chopStart('http://ugarit.com', ['https://', 'http://']);
...
$url = Str::chopEnd('ugarit.com/index.php', ['/index.html', '/index.php']);
...
$result = Str::deduplicate('The   Ugarit   Framework');
...
$html = Str::inlineMarkdown('**Ugarit**');

// <strong>Ugarit</strong>
```
...
If you specify a matching group within the expression, Ugarit will return a collection of the first matching group's matches:
...
The `Str::plural` method converts a singular word string to its plural form. This function supports [any of the languages supported by Ugarit's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
The `Str::pluralStudly` method converts a singular word string formatted in studly caps case to its plural form. This function supports [any of the languages supported by Ugarit's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$replaced = Str::replace(
    'php',
    'Ugarit',
    'PHP Framework for Web Scribes',
    caseSensitive: false
);

// Ugarit Framework for Web Scribes
```
...
$replaced = Str::replaceStart('Hello', 'Ugarit', 'Hello World');

// Ugarit World

$replaced = Str::replaceStart('World', 'Ugarit', 'Hello World');
...
$replaced = Str::replaceEnd('World', 'Ugarit', 'Hello World');

// Hello Ugarit

$replaced = Str::replaceEnd('Hello', 'Ugarit', 'Hello World');
...
The `Str::singular` method converts a string to its singular form. This function supports [any of the languages supported by Ugarit's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$slug = Str::slug('Ugarit 5 Framework', '-');
...
$string = Str::squish('    ugarit    framework    ');
...
$converted = Str::substr('The Ugarit Framework', 4, 7);
...
$string = Str::ucwords('ugarit framework');
...
If you would like to retrieve a `Heritage\Support\Carbon` date instance representing the date and time that a given ULID was created, you may use the `createFromId` method provided by Ugarit's Carbon integration:
...
Str::wrap('is', before: 'This ', after: ' Ugarit!');
...
The `str` function returns a new `Heritage\Support\Stringable` instance of the given string. This function is equivalent to the `Str::of` method:
...
If no argument is provided to the `str` function, the function returns an instance of `Heritage\Support\Str`:
...
$url = Str::of('https://ugarit.com')->chopStart('https://');
...
$url = Str::of('http://ugarit.com')->chopStart(['https://', 'http://']);
...
$url = Str::of('https://ugarit.com')->chopEnd('.com');
...
$url = Str::of('http://ugarit.com')->chopEnd(['.com', '.io']);
...
$result = Str::of('The   Ugarit   Framework')->deduplicate();
...
$result = Str::of('Ugarit')->exactly('Ugarit');
...
$html = Str::of('**Ugarit**')->inlineMarkdown();
...
$result = Str::of('Ugarit')->trim()->isEmpty();
...
$result = Str::of('Ugarit')->trim()->isNotEmpty();
...
$result = Str::of('ugarit')->isMatch('/foo (.*)/');
...
$padded = Str::of('Ugarit')->newLine()->append('Framework');
...
$hash = Str::of('Ugarit')->pipe('md5')->prepend('Checksum: ');
...
The `plural` method converts a singular word string to its plural form. This function supports [any of the languages supported by Ugarit's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$string = Str::of('Framework')->prepend('Ugarit ');
...
$replaced = Str::of('Ugarit 6.x')->replace('6.x', '7.x');
...
$replaced = Str::of('Hello World')->replaceStart('Hello', 'Ugarit');

// Ugarit World

$replaced = Str::of('Hello World')->replaceStart('World', 'Ugarit');
...
$replaced = Str::of('Hello World')->replaceEnd('World', 'Ugarit');

// Hello Ugarit

$replaced = Str::of('Hello World')->replaceEnd('Hello', 'Ugarit');
...
The `singular` method converts a string to its singular form. This function supports [any of the languages supported by Ugarit's pluralizer](/docs/{{version}}/localization#pluralization-language):
...
$slug = Str::of('Ugarit Framework')->slug('-');
...
$string = Str::of('    ugarit    framework    ')->squish();
...
$result = Str::of('<a href="https://ugarit.com">Taylor <b>Otwell</b></a>')->stripTags();

// Taylor Otwell

$result = Str::of('<a href="https://ugarit.com">Taylor <b>Otwell</b></a>')->stripTags('<b>');
...
$string = Str::of('Ugarit Framework')->substr(8);

// Framework

$string = Str::of('Ugarit Framework')->substr(8, 5);
...
$string = Str::of('The Framework')->substrReplace(' Ugarit', 3, 0);
...
$result = Str::of('Ugarit Framework')->test('/Ugarit/');
...
The `toHtmlString` method converts the given string to an instance of `Heritage\Support\HtmlString`, which will not be escaped when rendered in Blade templates:
...
The `toUri` method converts the given string to an instance of [Heritage\Support\Uri](/docs/{{version}}/helpers#uri):
...
The `trim` method trims the given string. Unlike PHP's native `trim` function, Ugarit's `trim` method also removes unicode whitespace characters:

```php
use Heritage\Support\Str;

$string = Str::of('  Ugarit  ')->trim();
...
The `ltrim` method trims the left side of the string. Unlike PHP's native `ltrim` function, Ugarit's `ltrim` method also removes unicode whitespace characters:

```php
use Heritage\Support\Str;

$string = Str::of('  Ugarit  ')->ltrim();
...
The `rtrim` method trims the right side of the given string. Unlike PHP's native `rtrim` function, Ugarit's `rtrim` method also removes unicode whitespace characters:

```php
use Heritage\Support\Str;

$string = Str::of('  Ugarit  ')->rtrim();
...
$string = Str::of('ugarit framework')->ucwords();
...
Str::of('-Ugarit-')->unwrap('-');

// Ugarit

Str::of('{framework: "Ugarit"}')->unwrap('{', '}');
...
$string = Str::of('ugarit')->whenExactly('ugarit', function (Stringable $string) {
    return $string->title();
});
...
$string = Str::of('framework')->whenNotExactly('ugarit', function (Stringable $string) {
    return $string->title();
});
...
$string = Str::of('ugarit')->whenIsAscii(function (Stringable $string) {
    return $string->title();
});
...
$string = Str::of('ugarit framework')->whenTest('/ugarit/', function (Stringable $string) {
    return $string->title();
});
...
Str::is('is')->wrap(before: 'This ', after: ' Ugarit!');
